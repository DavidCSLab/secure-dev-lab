...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  /* /ftp file download only (directory listing disabled) */ // vuln-code-snippet neutral-line directoryListingChallenge
  app.use('/ftp(?!/quarantine)/:file', servePublicFiles()) // vuln-code-snippet vuln-line directoryListingChallenge
  app.use('/ftp/quarantine/:file', serveQuarantineFiles()) // vuln-code-snippet neutral-line directoryListingChallenge

  /* /.well-known static files (no directory listing) */
  app.use('/.well-known', express.static('.well-known', { dotfiles: 'deny', index: false }))

  /* /encryptionkeys static file access (no directory listing) */
  app.use('/encryptionkeys/:file', serveKeyFiles())

  /* /logs access without directory listing */ // vuln-code-snippet neutral-line accessLogDisclosureChallenge
